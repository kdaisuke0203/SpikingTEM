...
def get_data(save_dirs, run, date, recent=-1, index=None, smoothing=0, n_envs_save=None):
    ...
    params_path = path.join(params_path[:-6]) if 'iter_' in str(params_path[-6:-1]) else save_path
    ...
    #print("g_timeseries",g_timeseries[0][0])
    #print("g_pre2_timeseries",g_pred2_timeseries[0][0])
    #print("env",env)
